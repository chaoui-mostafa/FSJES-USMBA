...
@section('content')
    <div class="fixed inset-0 bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-900 dark:to-gray-800 overflow-y-auto">

        <div class="min-h-screen flex items-center justify-center p-4">


            <div class="max-w-5xl w-full bg-white dark:bg-gray-800 rounded-xl overflow-hidden flex shadow-2xl">
                     <!-- Dark Mode Toggle -->

                <!-- Left side - Login form -->
                <div class="w-full md:w-1/2 p-10 space-y-6">
                    <div class="text-center">
                        <h2 class="text-3xl font-bold text-lime-600 dark:text-lime-500">Bienvenue</h2>
                        <p class="mt-2 text-sm text-blue-700 dark:text-blue-400">Veuillez vous connecter à votre compte</p>
                    </div>
                    ...
                    <form class="space-y-6" action="{{ route('login') }}" method="POST">
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input id="email" name="email" type="email" autocomplete="email" required
                                        class="block w-full pl-10 pr-3 py-3 border border-gray-300 dark:border-gray-600 rounded-lg placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white transition duration-300"
                            ...
                            <div>
                                <div class="flex justify-between items-center mb-1">
                                    ...
                                    <a href="{{ route('password.request') }}" class="text-sm text-blue-600 dark:text-blue-400 hover:text-blue-500 dark:hover:text-blue-300 transition duration-300">Mot de passe oublié ?</a>
                                </div>
                                <div class="relative">
                                    <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                        <svg class="h-5 w-5 text-gray-400 dark:text-gray-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                        ...
                        <div class="flex items-center">
                            <input id="remember-me" name="remember-me" type="checkbox" class="h-4 w-4 text-blue-600 dark:text-blue-500 focus:ring-blue-500 border-gray-300 dark:border-gray-600 rounded">
                            <label for="remember-me" class="ml-2 block text-sm text-gray-700 dark:text-gray-300">Se souvenir de moi</label>
                        </div>

                        <div>
                            <button type="submit"
                                class="w-full flex justify-center py-3 px-4 border border-transparent rounded-lg text-sm font-medium text-white bg-blue-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition duration-300">
                                Se connecter
                            </button>
                        </div>
                    </form>
            ...
            <div class="hidden md:block md:w-1/2 bg-gradient-to-br from-green-500 to-indigo-600 relative overflow-hidden">
                <div id="slider" class="absolute inset-0 flex items-center justify-center p-8 text-white">
                    ...
                    <div class="slide absolute inset-0 flex flex-col items-center justify-center p-6 md:p-8 transition-all duration-1000 ease-[cubic-bezier(0.83,0,0.17,1)] transform translate-x-0 opacity-100">
                        ...
                        <img src="{{ asset('images/th.jpeg') }}" alt="Image 2" class="w-48 h-48 md:w-64 md:h-64 object-contain rounded-lg shadow-lg" style="border-radius: 40%;">
                    ...
                    <div class="slide absolute inset-0 flex flex-col items-center justify-center p-6 md:p-8 transition-all duration-1000 ease-[cubic-bezier(0.83,0,0.17,1)] transform translate-x-full opacity-0">
                        ...
                        <img src="{{ asset('images/slide2.jpg') }}" alt="Image 2" class="w-48 h-48 md:w-64 md:h-64 object-contain rounded-lg shadow-lg" style="border-radius: 40%;">
