...
<div class="bg-white shadow overflow-hidden sm:rounded-lg">
            ...
            <div class="w-full">
                ...
                <div class="relative">
                    ...
                    <input type="file" id="excel-file" name="excel_file" accept=".xlsx, .xls, .csv" required
                           class="block w-full pl-10 border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500 text-xs sm:text-sm">
                </div>
            </div>
            <button type="submit"
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 mt-3">
                <div>
                    ...
                    <input type="text" id="search-nom" placeholder="Rechercher par nom..."
                           class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-1 px-2 focus:outline-none focus:ring-blue-500 focus:border-blue-500 text-xs sm:text-sm">
                </div>
                <div>
                ...
                <div class="flex items-end gap-2">
                    <button id="reset-search" class="bg-gray-200 text-gray-700 px-3 py-1 rounded-md text-xs sm:text-sm hover:bg-gray-300 transition-colors w-full">
                        Réinitialiser
                    </button>
                </div>
            </div>
    ...
    <div class="border-t border-gray-200 hidden sm:block">
        <table class="min-w-full divide-y divide-gray-200" id="profs-table">
            <thead class="bg-gray-50">
                <tr>
                    <th class="px-4 sm:px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Nom et Prénom</th>
                    <th class="px-4 sm:px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Email Professionnel</th>
                    ...
                    <th class="px-4 sm:px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Département</th>
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr class="prof-row">
                    <td class="px-4 sm:px-6 py-4 whitespace-nowrap nom">{{ $prof->nom_prenom }}</td>
                    <td class="px-4 sm:px-6 py-4 whitespace-nowrap">{{ $prof->email_professionnel }}</td>
                    <td class="px-4 sm:px-6 py-4 whitespace-nowrap">{{ $prof->numero_telephone }}</td>
                    <td class="px-4 sm:px-6 py-4 whitespace-nowrap grade">{{ $prof->grade }}</td>
                    <td class="px-4 sm:px-6 py-4 whitespace-nowrap">{{ $prof->departement }}</td>
    ...
    <div class="sm:hidden space-y-3 p-3">
        @foreach($profs as $prof)
        <div class="prof-row bg-white rounded-lg shadow p-4">
            <div class="flex justify-between items-start">
                <div>
                    <h4 class="font-medium text-gray-900">{{ $prof->nom_prenom }}</h4>
    ...
    <div class="px-3 sm:px-4 py-2 sm:py-3 bg-gray-50 border-t border-gray-200 flex flex-col sm:flex-row items-center justify-between gap-2">
        ...
        <div class="flex space-x-1">
            <!-- Previous Page -->
            <a href="{{ $profs->previousPageUrl() }}" class="px-2 py-1 rounded-md border border-gray-300 text-xs sm:text-sm font-medium {{ $profs->onFirstPage() ? 'bg-gray-100 text-gray-400 cursor-not-allowed' : 'bg-white text-gray-700 hover:bg-gray-50' }}">
            ...
            <!-- Next Page -->
            <a href="{{ $profs->nextPageUrl() }}" class="px-2 py-1 rounded-md border border-gray-300 text-xs sm:text-sm font-medium {{ $profs->hasMorePages() ? 'bg-white text-gray-700 hover:bg-gray-50' : 'bg-gray-100 text-gray-400 cursor-not-allowed' }}">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
