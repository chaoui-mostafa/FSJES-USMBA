...
<div class="py-6 px-4 sm:px-6 lg:px-8">
    <div class="max-w-2xl mx-auto">
        <div class="flex justify-between items-center mb-6">
            ...
            <a href="{{ route('users.index') }}" class="text-sm text-blue-600 hover:text-blue-900 dark:text-blue-400 flex items-center">
                ...
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                    ...
                    <div class="sm:col-span-2">
                        <div class="border-t border-gray-200 dark:border-gray-700 pt-4 mt-4">
                            <h3 class="text-lg font-medium text-gray-900 dark:text-white mb-3">Sécurité du Compte</h3>

                            @if($user->locked_until && $user->locked_until > now())
                                <div class="flex items-center justify-between bg-red-50 dark:bg-red-900/30 p-4 rounded-lg">
                                    <div>
                            ...
                            @else
                                <div class="flex items-center justify-between bg-yellow-50 dark:bg-yellow-900/20 p-4 rounded-lg">
                                    <div>
